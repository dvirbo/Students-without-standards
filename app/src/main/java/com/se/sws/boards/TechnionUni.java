...
/**
 * Technion University Board where items can be displayed
 *
...
public class TechnionUni extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View tech = findViewById(R.id.imageAddPostMain_Technion); // We click on technion University board add post button ('(+)' button)
        _intent = getIntent();
        ...
        mCreatePostsFab = (ImageView) tech;
        ...
        ImageView imageAddItemMain = (ImageView) tech;
        imageAddItemMain.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("University","Technion"); // Pass variables to AddProducts activity
                                                           ...
                                                           public boolean onMenuItemClick(MenuItem item) {
                                                               ...
                                                               builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                                                   ...
                                                                   public void onClick(DialogInterface dialogInterface, int i) {
                                                                       DocumentReference documentReference=firebaseFirestore.collection("Universities").document("Technion").collection("All").document(docId);
