...
public class HebrewUni extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View hebrew = findViewById(R.id.imageAddPostMain_Heb); // We click on hebrew University board add post button ('(+)' button)
        _intent = getIntent();
        ...
        mCreatePostsFab = (ImageView) hebrew;
        ...
        ImageView imageAddItemMain = (ImageView) hebrew;
        imageAddItemMain.setOnClickListener(view -> {
            Intent intent = new Intent(getApplicationContext(), AddProducts.class);
            intent.putExtra("University","heb"); // Pass variables to AddProducts activity
        ...
        Query query=firebaseFirestore.collection("Universities").document("heb").collection("All").orderBy("title", Query.Direction.ASCENDING);
                ...
                popupButton.setOnClickListener(v -> {
                    ...
                    popupMenu.getMenu().add("Delete").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(HebrewUni.this);
                            ...
                            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    DocumentReference documentReference=firebaseFirestore.collection("Universities").document("heb").collection("All").document(docId);
