...
/**
 * Ben Gurion University Board where items can be displayed
 *
...
public class BenGurion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View BGU = findViewById(R.id.imageAddPostMain_BG); // We click on BGU University board add post button ('(+)' button)
        _intent = getIntent();
                               ...
                               public boolean onMenuItemClick(MenuItem item) {
                                   ...
                                   builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                       ...
                                       public void onClick(DialogInterface dialogInterface, int i) {
                                           DocumentReference documentReference=firebaseFirestore.collection("BGU").document("All").collection("items").document(docId);
