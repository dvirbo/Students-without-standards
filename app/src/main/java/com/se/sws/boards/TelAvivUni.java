...
public class TelAvivUni extends AppCompatActivity {
    ...
    ImageView mCreateNotesFab; // Background
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View TLV = findViewById(R.id.imageAddPostMain_tlv);  // We click on Tel Aviv University board add post button ('(+)' button)
        _intent = getIntent();
        flag = _intent.getBooleanExtra("isAdmin", false); // Is the user admin or not

        mCreateNotesFab = (ImageView) TLV;
        firebaseAuth = FirebaseAuth.getInstance();

        firebaseUser = FirebaseAuth.getInstance().getCurrentUser(); // Will be used for representatives of each university
        firebaseFirestore = FirebaseFirestore.getInstance();

        //Objects.requireNonNull(getSupportActionBar()).setTitle("Tel Aviv Posts");

        ImageView imageAddItemMain = (ImageView) TLV;
        ...
        // If user is an admin a post add option will be available - part of admin panel
        if (flag) {
                   ...
                   public void onClick(View v) {
                       ...
                       popupMenu.getMenu().add("Delete").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                           ...
                           public boolean onMenuItemClick(MenuItem item) {
                               AlertDialog.Builder builder = new AlertDialog.Builder(TelAvivUni.this);
                               ...
                               builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                   ...
                                   public void onClick(DialogInterface dialogInterface, int i) {
                                       DocumentReference documentReference=firebaseFirestore.collection("tlv").document("All").collection("items").document(docId);
    ...
    public void backTlv(View view){
        Intent intent = new Intent(TelAvivUni.this, Universities.class);
