...
/**
 * Reichman University Board where items can be displayed
 *
...
public class ReichmanUni extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View reich = findViewById(R.id.imageAddPostMain_reicman); // We click on hebrew University board add post button ('(+)' button)
        _intent = getIntent();
        ...
        mCreatePostsFab = (ImageView) reich;
        ...
        ImageView imageAddItemMain = (ImageView) reich;
        imageAddItemMain.setOnClickListener(view -> {
            Intent intent = new Intent(getApplicationContext(), AddProducts.class);
            intent.putExtra("University","Reicman"); // Pass variables to AddProducts activity
        ...
        // Gets all the storage that goes under the path Reicman>All>items & sort the items by title
        //.collection("Universities").document(uniName).collection("All").document("items")
        Query query=firebaseFirestore.collection("Universities").document("Reicman").collection("All").orderBy("title", Query.Direction.ASCENDING);
                ...
                popupButton.setOnClickListener(v -> {
                    ...
                    popupMenu.getMenu().add("Delete").setOnMenuItemClickListener(new MenuItem.OnMenuItemClickListener() {
                        ...
                        public boolean onMenuItemClick(MenuItem item) {
                            AlertDialog.Builder builder = new AlertDialog.Builder(ReichmanUni.this);
                            ...
                            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialogInterface, int i) {
                                    DocumentReference documentReference=firebaseFirestore.collection("Universities").document("Reicman").collection("All").document(docId);
    ...
    public void backReich(View view){
        Intent intent = new Intent(ReichmanUni.this, Universities.class);
