...
public class ReichmanUni extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View reichman = findViewById(R.id.imageAddPostMain_reicman); // We click on Reichman University board add post button ('(+)' button)
        _intent = getIntent();
        flag = _intent.getBooleanExtra("isAdmin", false); // Is the user admin or not

        mCreatePostsFab = (ImageView) reichman;
        ...
        ImageView imageAddItemMain = (ImageView) reichman;
                       ...
                       public boolean onMenuItemClick(MenuItem item) {
                           ...
                           builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                               ...
                               public void onClick(DialogInterface dialogInterface, int i) {
                                   DocumentReference documentReference=firebaseFirestore.collection("Reicman").document("All").collection("items").document(docId);
